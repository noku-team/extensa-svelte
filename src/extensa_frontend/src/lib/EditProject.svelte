...
>
	<div class="space-y-6">
		<div class="space-y-2">
			<div class="text-white/60 text-sm uppercase tracking-wider">Nome area geografica</div>
		...
		<div class="space-y-2">
			<div class="text-white/60 text-sm uppercase tracking-wider">Coordinate</div>
